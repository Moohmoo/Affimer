`.sourceCpp_4_DLLInfo` <- dyn.load('/mnt/c/Users/oussa/Downloads/Master/Projet Long/Mohamed/Patch_Search/Tmp/sourceCpp-x86_64-pc-linux-gnu-1.0.9/sourcecpp_2fcd2f9ba6c5/sourceCpp_5.so')

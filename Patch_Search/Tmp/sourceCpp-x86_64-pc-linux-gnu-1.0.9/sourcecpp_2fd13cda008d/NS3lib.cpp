...
// distloc
double distloc(NumericMatrix X, int ind1, int ind2);
RcppExport SEXP sourceCpp_4_distloc(SEXP XSEXP, SEXP ind1SEXP, SEXP ind2SEXP) {
BEGIN_RCPP
...
// mapping_dist_sum
NumericVector mapping_dist_sum(NumericMatrix X, IntegerVector XRes, IntegerVector I, IntegerVector CI, NumericMatrix Y, IntegerVector YRes, IntegerVector J, IntegerVector CJ, double thresh);
RcppExport SEXP sourceCpp_4_mapping_dist_sum(SEXP XSEXP, SEXP XResSEXP, SEXP ISEXP, SEXP CISEXP, SEXP YSEXP, SEXP YResSEXP, SEXP JSEXP, SEXP CJSEXP, SEXP threshSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
...
// mapping_dist_sum2
NumericVector mapping_dist_sum2(NumericMatrix X, IntegerVector XRes, IntegerVector I, IntegerVector CI, NumericMatrix Y, IntegerVector YRes, IntegerVector J, IntegerVector CJ, double thresh);
RcppExport SEXP sourceCpp_4_mapping_dist_sum2(SEXP XSEXP, SEXP XResSEXP, SEXP ISEXP, SEXP CISEXP, SEXP YSEXP, SEXP YResSEXP, SEXP JSEXP, SEXP CJSEXP, SEXP threshSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
...
IntegerVector getConnectedNeighborsc(IntegerVector C, IntegerMatrix V, NumericMatrix X, NumericMatrix Y, double thresh, int nbnei);
RcppExport SEXP sourceCpp_4_getConnectedNeighborsc(SEXP CSEXP, SEXP VSEXP, SEXP XSEXP, SEXP YSEXP, SEXP threshSEXP, SEXP nbneiSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// vertexc
IntegerMatrix vertexc(CharacterVector XProp, CharacterVector YProp);
RcppExport SEXP sourceCpp_4_vertexc(SEXP XPropSEXP, SEXP YPropSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// buildGraphc
IntegerMatrix buildGraphc(NumericMatrix X, NumericMatrix Y, IntegerMatrix V, double thresh, double mindist, double maxdist);
RcppExport SEXP sourceCpp_4_buildGraphc(SEXP XSEXP, SEXP YSEXP, SEXP VSEXP, SEXP threshSEXP, SEXP mindistSEXP, SEXP maxdistSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
...
// buildGraph2c
IntegerMatrix buildGraph2c(NumericMatrix X, IntegerVector XRes, NumericMatrix Y, IntegerVector YRes, IntegerMatrix V, double thresh, double mindist, double maxdist);
RcppExport SEXP sourceCpp_4_buildGraph2c(SEXP XSEXP, SEXP XResSEXP, SEXP YSEXP, SEXP YResSEXP, SEXP VSEXP, SEXP threshSEXP, SEXP mindistSEXP, SEXP maxdistSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
